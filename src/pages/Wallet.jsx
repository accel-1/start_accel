...
import { useMetamask,useAddress ,ConnectWallet,useWalletConnect,useCoinbaseWallet,useDisconnect} from "@thirdweb-dev/react";
    ...
    const [dataWallet] = useState([
        {
            ...
            loginfunction:connectWithMetamask
        },
        {
            id: 2,
            img: icon2,
